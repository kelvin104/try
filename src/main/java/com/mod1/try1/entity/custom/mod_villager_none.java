...
public class mod_villager_none extends AbstractIllager implements NeutralMob {

    private static final float MOB_HEALTH = 20.0F;
    private static final UniformInt PERSISTENT_ANGER_TIME = TimeUtil.rangeOfSeconds(20, 39);
    private UUID persistentAngerTarget;
    private static final EntityDataAccessor<Integer> DATA_REMAINING_ANGER_TIME = SynchedEntityData.defineId(mod_villager_none.class, EntityDataSerializers.INT);
    ...
    public mod_villager_none(EntityType<mod_villager_none> p_35267_, Level p_35268_) {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes().add(Attributes.MOVEMENT_SPEED, 0.4D).add(Attributes.MAX_HEALTH, 20.0D).add(Attributes.ATTACK_DAMAGE, 1D).add(Attributes.ATTACK_KNOCKBACK,1D);
    }
