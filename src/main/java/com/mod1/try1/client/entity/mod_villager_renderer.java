...
public class mod_villager_renderer extends IllagerRenderer<mod_villager_class> {
    private static final ResourceLocation MOD_VILLAGER = new ResourceLocation("textures/entity/modvillager.png");
