...
public class mod_villager_jaw_model<T extends mod_villager_jaw> extends HierarchicalModel<T> implements ArmedModel, HeadedModel {
    ...
    public mod_villager_jaw_model(ModelPart p_170688_) {
        this.root = p_170688_;
