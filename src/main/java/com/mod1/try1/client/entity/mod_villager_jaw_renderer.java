...
import com.mod1.try1.client.entity.model.mod_villager_jaw_model;
...
public class mod_villager_jaw_renderer extends MobRenderer<mod_villager_jaw, mod_villager_jaw_model<mod_villager_jaw>> {
    ...
    private static final ResourceLocation MOD_VILLAGER_JAW = new ResourceLocation(Main.MOD_ID,"textures/entity/modvillager/modvillager_jaw.png");
    // private static final ModelLayerLocation MOD_VILLAGER_MODEL = new ModelLayerLocation(MOD_VILLAGER,"mod_villager");
    public mod_villager_jaw_renderer(EntityRendererProvider.Context p_174439_) {
        ...
        super(p_174439_, new mod_villager_jaw_model<>(p_174439_.bakeLayer(ModelLayers.VINDICATOR)), 0.5F);


    }

    @Override
    public ResourceLocation getTextureLocation(mod_villager_jaw p_114482_) {
        return MOD_VILLAGER_JAW;
    }
