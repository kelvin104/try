...
public class mod_villager_none_model<T extends mod_villager_none> extends HierarchicalModel<T> implements ArmedModel, HeadedModel {
    ...
    public mod_villager_none_model(ModelPart p_170688_) {
        this.root = p_170688_;
