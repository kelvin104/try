...
public class mod_villager_neutral_model<T extends mod_villager_neutral> extends HierarchicalModel<T> implements ArmedModel, HeadedModel {
    ...
    public mod_villager_neutral_model(ModelPart p_170688_) {
        this.root = p_170688_;
...
//public class mod_villager_model<T extends mod_villager_class> extends HierarchicalModel<T> implements ArmedModel, HeadedModel {
    /*
    private final ModelPart root;
    private final ModelPart head;
    private final ModelPart hat;
    ...
    public mod_villager_model(ModelPart p_170688_) {
        this.root = p_170688_;
        this.head = p_170688_.getChild("head");
        this.hat = this.head.getChild("hat");
        this.hat.visible = false;
